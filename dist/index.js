...
async function sendArtistConfirmation(artistName, artistEmail, songTitle) {
  const html = `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    <div class="header">
      <h1>\u{1F3B5} Submission Received!</h1>
    </div>
    <div class="content">
      ...
      <div class="highlight">
        ...
        Submitted: <strong>${(/* @__PURE__ */ new Date()).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</strong>
      </div>
    ...
    <div class="footer">
      <p>\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} AE Music Lab | Powered by Armhen Entertainment</p>
...
A division of Armhen Entertainment
  ...
  return sendEmail({
    to: artistEmail,
    subject: "\u{1F3B5} Your Music Submission to AE Music Lab - Confirmed!",
    html,
    text: text2
  });
}
